    ...
    <div className="modal-dialog modal-dialog-centered" role="document">
      ...
      >
        ...
        <div
          ...
          style={{ 
            overflowY: "auto", 
            maxHeight: "calc(90vh - 50px)" // zostaw miejsce na nagłówek i przycisk
          }}
        >
          {/* Tytuł */}
          ...
          <textarea
            ...
            style={{ borderRadius: "5px", resize: "vertical", minHeight: "80px" }}
          />

          {/* Zapisz */}
          <button
            className="btn btn-success px-5 mt-auto"
            onClick={handleSave}
            disabled={!reviewText}
          >
            {buttonText}
