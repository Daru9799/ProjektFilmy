...
const DirectorPage = () => {
  ...
  useEffect(() => {
    const fetchActorById = async () => {
      try {
        const directorResponse = await axios.get(`https://localhost:7053/api/Directors/${directorId}`);
      ...
      <div className="row my-4">
        ...
        <div className="col-3">
          <div className="p-2 text-center">
            <img
              src={director?.photoUrl || "/path/to/defaultPoster.jpg"}
              alt="Poster"
              className="img-fluid"
              style={{
                width: "100%",
        ...
        <div className="col-8" style={{ textAlign: "left", marginLeft: "50px", marginTop: "20px" }}>
          ...
          <p style={{marginTop:"50px"}}>
            ...
            {director?.birthDate ? new Date(director.birthDate).toLocaleDateString('pl-PL', { year: 'numeric', month: 'long', day: 'numeric' }) : "Brak danych"}
          </p>
